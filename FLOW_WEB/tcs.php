...
$sql = "select * from tcs ORDER BY id DESC limit 7";
...
<section id="about" class="s-about " style="padding: 40px;">
    <h1 style="text-align: center;font-size: 40px;margin-top: -10px;"><span style="color: #d9083c; ">TCS </span>Jobs</h1>
    <div class="container ">
     <?php
