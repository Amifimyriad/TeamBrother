...
$sql = "select * from cognizant ORDER BY id DESC limit 7";
...
<head>
    ...
    ================================================== -->
    <meta charset="utf-8">
    <title>Cognizent job list</title>
...
<section id="about" class="s-about " style="padding: 40px;">
    <h1 style="text-align: center;font-size: 40px;margin-top: -10px;"><span style="color: #d9083c; ">Cognizent </span>Jobs</h1>
    <div class="container ">
     <?php
...
<div class="col-sm-12 ">
<div class="card">
  <h5 class="card-header" style="color:#d9083c; font-size: 20px;line-height: 1.2;"><?php echo $result['title']; ?></h5>
  <div class="card-body">
    <p class="card-text" style="color: white;"><?php echo $result['content']; ?></p>
